...
* It uses [[imports#InsightFace|InsightFace]] for detection and embeddings
* [[imports#ZED SDK|ZED SDK]] provides depth information to calculate distance
...
* [[imports#GFPGAN|GFPGAN]] is integrated to restore and enhance face images
