...
Terminal 1: The Backend (Camera & AI Engine)
This script captures video, runs recognition, and hosts the video stream server.
...
Important: Open dashboard.py and ensure STREAM_URL matches the IP from Terminal 1.
