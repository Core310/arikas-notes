...
```bash
git clone https://github.com/yourusername/fnr-facial-net-recognizer.git
...
Open your browser to the URL shown (usually [http://localhost:8501](http://localhost:8501)).

Tailscale Usage
Use Tailscale IP for remote access to the Flask stream.

Update STREAM_URL in the dashboard script with your Tailscale IP (e.g., [http://100.x.x.x:5001/video_feed](http://100.x.x.x:5001/video_feed)).
