...
2) $\lim_{ (x,y) \to (0,0) }\frac{{x^2-y^2}}{x-y}$

for 1) 
- $r_{1}(t)=t<2,1>,t_{0}=0$
- $r_{2}(t)=<t^2,t>,t_{0}=0$
- Then we plug in $r_{1},r_{2}$ for $(x,y)$ into the limit and solve. We still obtain some DNE, and hence can't solve 
...
Vector projection 
= $\frac{dot}{mag}$
scalar is mag over vectror projection 